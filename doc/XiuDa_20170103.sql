...
insert  into `sys_menu`(`menu_id`,`parent_id`,`parent_ids`,`name`,`type`,`url`,`perms`,`icon`,`order_num`,`available`) values (1,0,'0/','系统管理',0,'','','',0,1),(2,1,'0/1/','菜单管理',1,'/sys/menu/list','','',0,1),(3,1,'0/1/','角色管理',1,'/sys/role/list','','',0,1),(4,0,'0/','工单管理',0,'','','',0,1),(5,4,'0/4/','工单列表',1,'/sys/menu/list','','',0,1),(6,4,'0/4/','工单报表',1,'/sys/role/list','','',0,1),(7,2,'0/1/2/','菜单新建',2,'','','',0,1),(8,2,'0/1/2/','菜单修改',2,'/sys/menu/list','','',0,1),(9,2,'0/1/2/','菜单删除',2,'/sys/role/list','','',0,1),(10,5,'0/4/5/','工单修改',2,'','','',0,1),(11,5,'0/4/5/','工单新建',2,'','','',0,1),(12,3,'0/1/3/','角色新增',2,'','','',0,1),(13,3,'0/1/3/','角色修改',2,'','','',0,1),(14,3,'0/1/3/','角色删除',2,'','','',0,1);
...
insert  into `xiuda_fuwushang`(`fws_id`,`fws_bianhao`,`fws_mingcheng`,`fws_jiancheng`,`fws_leibie`,`fws_cs_bianhao`,`fws_dizhi`,`fws_jingdu`,`fws_weidu`,`Fws_logo`,`Fws_zhuangtai`) values (NULL,'1920840918','小猪猪精修服务商','小猪猪','123','110101','天河公园黄埔大道员村23号','113.372814','23.134261','images/logo.png',1);
